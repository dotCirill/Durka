...
Пусть $L$ -- множество мат. об-в, в кот-м введена операцися сложения, отн. кот-й $L$ -- абелева группа. Пусть кроме того в $L$ вв. оп. умножения на скаляр (из $\mathbb{R, C}$, т.е. числа), обл. свойствами:
